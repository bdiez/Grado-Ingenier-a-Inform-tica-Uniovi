...
public class VentanaRegistro extends JDialog { //Como va a ser ventana secundaria se pone JDialog
	...
	public VentanaRegistro() {
		...
		lblUsuarioemail.setLabelFor(textFieldUsuario);
		...
		lblReintroduzcaLaContrasea.setLabelFor(passwordFieldRepetir);
			...
			btnSiguiente.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					if (getTextFieldNombre().getText().isEmpty()
						...
						JOptionPane
								.showMessageDialog(null, "Error: Hay campos vacios");
	...
	private JPanel getPanelEdad() {
		if (panelEdad == null) {
			...
			panelEdad.add(getComboBoxMes());
			panelEdad.add(getComboBoxAño());
		}
		return panelEdad;
	}

	private Component getComboBoxAño() {
	...
	private Component getComboBoxMes() {
